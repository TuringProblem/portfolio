...
1. **Install the plugin** using your preferred package manager (see [Installation Guide](https://github.com/TuringProblem/shifty-vim#installation))
...
For detailed installation instructions, see the [Installation Guide](https://github.com/TuringProblem/shifty-vim#installation).
...
[Documentation](https://github.com/TuringProblem/shifty-vim) • [Report Bug](https://github.com/TuringProblem/shifty-vim/issues) • [Request Feature](https://github.com/TuringProblem/shifty-vim/issues)
