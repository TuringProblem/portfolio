...
var $author$project$Main$viewAbout = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Software engineer based in Boston. I like building clean, useful things.')
				]))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('mailto:tazizthegreat@gmail.com')
						]),
					_List_fromArray(
						[
...
var $author$project$Projects$projects = _List_fromArray(
	[
		...
		tags: _List_fromArray(
			['Elm', 'CSS']),
		title: 'Project One',
		url: $author$project$Projects$urlLink
	},
		{
		description: 'A short description of what this project does and why it matters.',
		tags: _List_fromArray(
...
var $author$project$Projects$viewProject = function (project) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Projects$viewTag, project.tags))
			]));
};
var $author$project$Projects$viewProjects = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$core$List$map, $author$project$Projects$viewProject, $author$project$Projects$projects))
		]));
