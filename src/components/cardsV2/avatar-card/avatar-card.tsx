...
const backgroundMap: Record<Background, string[]> = {
  massasoit: ['bg-[var(--avatar-card-massasoit)]', 'border-[var(--avatar-card-border-massasoit)]', 'flex-grid grid-cols-2 sm:grid-cols-1', 'text-[var(--massasoit-text)]'],
  northeastern: ['bg-[var(--avatar-card-northeastern)]', 'border-[var(--avatar-card-border-northeastern)]', 'flex-grid grid-cols-3', 'text-[var(--northeastern-text)]'],
}
