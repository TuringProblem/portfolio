...
const CardContent: React.FC = () => {
  ...
  return (
    ...
    <BaseCard className="flex-col shadow-xs justify-center items-center p-[24px] min-w-[400px] min-h-[800px] bg-[var(--about-card-background)] border border-transparent hover:border-[var(--ifm-color-primary)] shadow-[0px_0.5px_1px_0px] hover:shadow-[0px_0.5px_1px_0px] w-full h-full">
      <div>
